...
#include "../../Cli/Labs/MI_Client/network.h"
...
QT_MOC_LITERAL(1, 8, 7), // "onReady"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 8), // "Network*"
QT_MOC_LITERAL(4, 26, 3), // "net"
QT_MOC_LITERAL(5, 30, 11), // "OnResultGet"
QT_MOC_LITERAL(6, 42, 14), // "QNetworkReply*"
QT_MOC_LITERAL(7, 57, 5), // "reply"
QT_MOC_LITERAL(8, 63, 12) // "OnResultPost"

    },
    "Network\0onReady\0\0Network*\0net\0OnResultGet\0"
    "QNetworkReply*\0reply\0OnResultPost"
};
...
void Network::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onReady((*reinterpret_cast< Network*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Network::*)(Network * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Network::onReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Network::onReady(Network * _t1)
{
