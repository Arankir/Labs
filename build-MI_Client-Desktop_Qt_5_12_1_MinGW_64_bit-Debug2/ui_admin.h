...
public:
    ...
    void setupUi(QWidget *Admin)
    {
        ...
        GBA6->setGeometry(QRect(220, 40, 641, 511));
        ...
        A6BI6->setGeometry(QRect(520, 350, 21, 23));
        QFont font2;
        ...
        A6BI7->setGeometry(QRect(540, 350, 21, 23));
        A6BI7->setFont(font2);
        A6BI8 = new QPushButton(GBA6);
        A6BI8->setObjectName(QString::fromUtf8("A6BI8"));
        A6BI8->setGeometry(QRect(580, 350, 21, 23));
        A6BI8->setFont(font2);
        A6BI9 = new QPushButton(GBA6);
        A6BI9->setObjectName(QString::fromUtf8("A6BI9"));
        A6BI9->setGeometry(QRect(600, 350, 21, 23));
        A6BI9->setFont(font2);
        A6TV = new QTableView(GBA6);
        A6TV->setObjectName(QString::fromUtf8("A6TV"));
        A6TV->setGeometry(QRect(10, 20, 491, 421));
        A6SA = new QScrollArea(GBA6);
        A6SA->setObjectName(QString::fromUtf8("A6SA"));
        A6SA->setGeometry(QRect(10, 440, 491, 61));
        A6SA->setSizeIncrement(QSize(0, 0));
        A6SA->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOn);
        ...
        A6LE1 = new QLineEdit(scrollAreaWidgetContents_3);
        A6LE1->setObjectName(QString::fromUtf8("A6LE1"));
        A6LE1->setGeometry(QRect(10, 20, 51, 20));
        A6L5 = new QLabel(scrollAreaWidgetContents_3);
        A6L5->setObjectName(QString::fromUtf8("A6L5"));
        A6L5->setGeometry(QRect(250, 0, 47, 13));
        A6LE2 = new QLineEdit(scrollAreaWidgetContents_3);
        A6LE2->setObjectName(QString::fromUtf8("A6LE2"));
        A6LE2->setGeometry(QRect(70, 20, 51, 20));
        A6L3 = new QLabel(scrollAreaWidgetContents_3);
        A6L3->setObjectName(QString::fromUtf8("A6L3"));
        A6L3->setGeometry(QRect(130, 0, 47, 13));
        A6LE5 = new QLineEdit(scrollAreaWidgetContents_3);
        A6LE5->setObjectName(QString::fromUtf8("A6LE5"));
        A6LE5->setGeometry(QRect(250, 20, 51, 20));
        A6LE3 = new QLineEdit(scrollAreaWidgetContents_3);
        A6LE3->setObjectName(QString::fromUtf8("A6LE3"));
        A6LE3->setGeometry(QRect(130, 20, 51, 20));
        ...
        A6L4 = new QLabel(scrollAreaWidgetContents_3);
        A6L4->setObjectName(QString::fromUtf8("A6L4"));
        A6L4->setGeometry(QRect(190, 0, 47, 13));
        A6L7 = new QLabel(scrollAreaWidgetContents_3);
        A6L7->setObjectName(QString::fromUtf8("A6L7"));
        A6L7->setGeometry(QRect(370, 0, 47, 13));
        A6LE4 = new QLineEdit(scrollAreaWidgetContents_3);
        A6LE4->setObjectName(QString::fromUtf8("A6LE4"));
        A6LE4->setGeometry(QRect(190, 20, 51, 20));
