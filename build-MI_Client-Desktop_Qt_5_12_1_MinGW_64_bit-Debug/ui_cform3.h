...
public:
    ...
    void setupUi(QWidget *cForm3)
    {
        ...
        DishMenu->setGeometry(QRect(340, 10, 191, 241));
    ...
    void retranslateUi(QWidget *cForm3)
    {
        ...
        dinner_2->setText(QApplication::translate("cForm3", "\321\203\320\266\320\270\320\275", nullptr));
